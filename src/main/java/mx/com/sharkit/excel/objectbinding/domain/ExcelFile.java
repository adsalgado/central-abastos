...
public class ExcelFile implements Serializable {
	...
	public ExcelFile(Sheet sheet, boolean hasHeader, int rowsPerThread, FileTemplate fileTemplate,
	...
	public String toString() {
		return "ExcelFile [hasHeader=" + hasHeader + ", rowsPerThread=" + rowsPerThread + ", sheetThreads="
				+ sheetThreads.values() + "]";
	}
