...
import { TransportistaService } from '../transportista';

@Component({
  selector: 'jhi-proveedor-transportista-update',
  templateUrl: './proveedor-transportista-update.component.html'
})
export class ProveedorTransportistaUpdateComponent implements OnInit {
  isSaving: boolean;
