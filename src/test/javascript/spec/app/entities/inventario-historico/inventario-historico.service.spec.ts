...
import { IInventarioHistorico, InventarioHistorico, TipoMovimiento } from 'app/shared/model/inventario-historico.model';
...
describe('Service Tests', () => {
  describe('InventarioHistorico Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a InventarioHistorico', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fechaMovimiento: currentDate.format(DATE_TIME_FORMAT)
        ...
        service
          .create(new InventarioHistorico(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a InventarioHistorico', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of InventarioHistorico', async () => {
        const returnedFromService = Object.assign(
          {
            tipoMovimiento: 'BBBBBB',
            cantidad: 1,
      ...
      it('should delete a InventarioHistorico', async () => {
