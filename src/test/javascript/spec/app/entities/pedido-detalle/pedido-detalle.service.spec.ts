...
describe('Service Tests', () => {
  describe('PedidoDetalle Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a PedidoDetalle', async () => {
      ...
      it('should update a PedidoDetalle', async () => {
        const returnedFromService = Object.assign(
          {
            cantidad: 1,
            totalSinIva: 1,
      ...
      it('should return a list of PedidoDetalle', async () => {
        const returnedFromService = Object.assign(
          {
            cantidad: 1,
            totalSinIva: 1,
      ...
      it('should delete a PedidoDetalle', async () => {
