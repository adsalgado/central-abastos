...
describe('Service Tests', () => {
  describe('ParametrosAplicacion Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ParametrosAplicacion', async () => {
        ...
        service
          .create(new ParametrosAplicacion(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ParametrosAplicacion', async () => {
        const returnedFromService = Object.assign(
          {
            clave: 'BBBBBB',
            descripcion: 'BBBBBB'
      ...
      it('should return a list of ParametrosAplicacion', async () => {
        const returnedFromService = Object.assign(
          {
            clave: 'BBBBBB',
            descripcion: 'BBBBBB'
      ...
      it('should delete a ParametrosAplicacion', async () => {
