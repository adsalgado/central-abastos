...
describe('Service Tests', () => {
  describe('Recolector Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Recolector', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fechaAlta: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a Recolector', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            fechaAlta: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of Recolector', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            fechaAlta: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a Recolector', async () => {
