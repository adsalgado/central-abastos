...
describe('Service Tests', () => {
  describe('TransportistaTarifa Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a TransportistaTarifa', async () => {
        ...
        service
          .create(new TransportistaTarifa(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a TransportistaTarifa', async () => {
        const returnedFromService = Object.assign(
          {
            rangoMinimo: 1,
            rangoMaximo: 1,
      ...
      it('should return a list of TransportistaTarifa', async () => {
        const returnedFromService = Object.assign(
          {
            rangoMinimo: 1,
            rangoMaximo: 1,
      ...
      it('should delete a TransportistaTarifa', async () => {
