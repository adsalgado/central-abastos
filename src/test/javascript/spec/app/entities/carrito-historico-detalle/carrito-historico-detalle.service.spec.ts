...
describe('Service Tests', () => {
  describe('CarritoHistoricoDetalle Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CarritoHistoricoDetalle', async () => {
        ...
        service
          .create(new CarritoHistoricoDetalle(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a CarritoHistoricoDetalle', async () => {
        const returnedFromService = Object.assign(
          {
            cantidad: 1,
            precio: 1
      ...
      it('should return a list of CarritoHistoricoDetalle', async () => {
        const returnedFromService = Object.assign(
          {
            cantidad: 1,
            precio: 1
      ...
      it('should delete a CarritoHistoricoDetalle', async () => {
