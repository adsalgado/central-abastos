...
describe('Service Tests', () => {
  describe('Transportista Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Transportista', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fechaAlta: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a Transportista', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            fechaAlta: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of Transportista', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            fechaAlta: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a Transportista', async () => {
