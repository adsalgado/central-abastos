...
describe('Service Tests', () => {
  describe('CarritoCompra Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CarritoCompra', async () => {
      ...
      it('should update a CarritoCompra', async () => {
        const returnedFromService = Object.assign(
          {
            cantidad: 1,
            precio: 1
      ...
      it('should return a list of CarritoCompra', async () => {
        const returnedFromService = Object.assign(
          {
            cantidad: 1,
            precio: 1
      ...
      it('should delete a CarritoCompra', async () => {
