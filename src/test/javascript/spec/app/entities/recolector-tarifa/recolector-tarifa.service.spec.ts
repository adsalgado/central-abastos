...
describe('Service Tests', () => {
  describe('RecolectorTarifa Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a RecolectorTarifa', async () => {
        ...
        service
          .create(new RecolectorTarifa(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a RecolectorTarifa', async () => {
        const returnedFromService = Object.assign(
          {
            rangoMinimo: 1,
            rangoMaximo: 1,
      ...
      it('should return a list of RecolectorTarifa', async () => {
        const returnedFromService = Object.assign(
          {
            rangoMinimo: 1,
            rangoMaximo: 1,
      ...
      it('should delete a RecolectorTarifa', async () => {
